...
export async function loadBudgetBaseline() {
  ...
  const curatedPluginRoot = path.join(home, ".codex", "plugins", "cache", "codexplusplus-codexplusplus-codexplusplus-codexplusplus-codexplusplus-codexplusplus-codexplusplus-codexplusplus-codexplusplus-codexplusplus-codexplusplus-codexplusplus-codexplusplus-openai-curated");
