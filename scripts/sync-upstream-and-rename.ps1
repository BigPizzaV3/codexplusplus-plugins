param(
    ...
    [string]$Branch = "main",
    [string]$OldValue = "codexplusplus-codexplusplus-codexplusplus-openai-curated",
    [string]$NewValue = "codexplusplus-codexplusplus-codexplusplus-codexplusplus-openai-curated",
    [switch]$Push
)
